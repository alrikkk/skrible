          ...
          {activeTab === "options" && (
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3.5 bg-stone-50 hover:bg-stone-100 text-black border border-black/10 font-medium text-sm rounded-xl transition-all cursor-pointer shadow-2xs hover:border-black/20"
              >
