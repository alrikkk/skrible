...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <div className="w-full bg-[#FAF8F5] border-b border-black/10 pt-6 pb-12 px-4 sm:px-8 relative overflow-hidden">
      ...
      <div 
        className="absolute inset-0 opacity-40 pointer-events-none hero-dots"
        style={{
        ...
        <div className="flex items-center justify-between pb-8 mb-6 border-b border-black/10">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              title="skrible home"
            >
              <ScribbleLogo className="h-12 sm:h-14 w-auto text-black group-hover:scale-105 transition-transform" />
